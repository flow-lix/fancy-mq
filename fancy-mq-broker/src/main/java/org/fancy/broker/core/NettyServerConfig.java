...
public class NettyServerConfig extends NettyBaseConfig {
    ...
    private int serverSelectorThreads = Integer.parseInt(System.getProperty(
            ConfigurationKeys.TRANSPORT_PREFIX + "serverSelectorThreads", String.valueOf(ConfigurationKeys.WORKER_THREAD_SIZE)));
    ...
    private int serverWorkerThreads = Integer.parseInt(System.getProperty(
            ConfigurationKeys.TRANSPORT_PREFIX + "serverWorkerThreads", String.valueOf(ConfigurationKeys.WORKER_THREAD_SIZE)));
    ...
    public long getServerShutdownWaitTime() {
        return 3;
    }
}
