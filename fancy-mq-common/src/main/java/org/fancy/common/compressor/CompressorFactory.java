...
public class CompressorFactory {
     ...
     */
    protected static final Map<CompressionType, Compressor> COMPRESSOR_MAP = new ConcurrentHashMap<>();

    static {
        COMPRESSOR_MAP.put(CompressionType.NONE, new NoneCompressor());
    }
    ...
    public static Compressor getCompressor(byte code) {
        CompressionType type = CompressionType.getByCode(code);
